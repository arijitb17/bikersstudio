      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-16 py-12">
        <div className="bg-white rounded-lg shadow-md p-8 lg:p-12">
          ...
          <div className="prose max-w-none text-gray-700 space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Orders & Payments</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Shipping & Delivery</h2>
              <p>
