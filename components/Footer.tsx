    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-16 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-12 text-center md:text-left">
          <div>
            <h3 className="font-bold text-xl md:text-lg mb-4 uppercase">Quick Links</h3>
          ...
          <div>
            <h3 className="font-bold text-xl md:text-lg mb-4 uppercase">My Account</h3>
            <ul className="space-y-3 md:space-y-2 text-base md:text-sm">
          ...
          <div>
            <h3 className="font-bold text-xl md:text-lg mb-4 uppercase">Policies</h3>
            <ul className="space-y-3 md:space-y-2 text-base md:text-sm">
        ...
        {/* Middle Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-8 mb-8 text-center lg:text-left">
          <div className="flex flex-col items-center lg:items-start">
            <h3 className="font-bold text-xl md:text-lg mb-3 uppercase">Customer Care</h3>
            <div className="space-y-2 text-base md:text-sm">
              <p>Monday to Sunday, 10am–5pm</p>
              <p className="flex items-center justify-center lg:justify-start gap-2">
                <Phone className="w-5 h-5 md:w-4 md:h-4 shrink-0" />
                <Link href="tel:919678248499" className="hover:text-black/60 transition-colors">+91 96782 48499</Link>
              </p>
              <p className="flex items-center justify-center lg:justify-start gap-2">
                <Mail className="w-5 h-5 md:w-4 md:h-4 shrink-0" />
          ...
          <div className="flex flex-col items-center lg:items-start">
            <h3 className="font-bold text-xl md:text-lg mb-3 uppercase">Brand Store Guwahati</h3>
            ...
            <p className="flex items-start justify-center lg:justify-start gap-2 text-base md:text-sm mt-2 text-black/70 text-center lg:text-left">
              <MapPin className="w-5 h-5 md:w-4 md:h-4 shrink-0 mt-0.5 text-black" />
        ...
        <div className="text-center">
          <h3 className="font-bold text-xl md:text-lg mb-4 uppercase">Follow Us</h3>
          ...
          <div className="text-base md:text-sm text-black/80 pt-4 border-t border-black/20">
